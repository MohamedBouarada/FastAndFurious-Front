       ...
       <div className="container mt-4">
        <div className={styles.cont2} >
                    <div class="p-2 rounded">
                        <div className={styles.formCheck}> <input  type="radio" name="radio" required/> <label for="flexCheckDefault-1"> Autonome-Senior </label> </div>
                    </div>
                    ...
                    <div className="p-2 rounded">
                        <div className={styles.formCheck}> <input  type="radio" name="radio" /> <label for="flexCheckDefault-6"> Junior-Téléguidé </label> </div>                   
                    </div>
          </div>
  <br></br><br></br>
          ...
          <label className={styles.colOneHalf}>
            ...
            <input type="text" name="mem2" required />
          </label>
          <label className={styles.colOneHalf}>
            <span className={styles.labelText}>Nom&Prenom membre 3</span>
            <input type="text" name="mem3" required />
          </label>
          <label className={styles.colOneHalf}>
