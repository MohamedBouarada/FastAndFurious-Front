...
class Footer extends React.Component {
    ...
    return(
        ...
        <ul className={styles.social_icon}>
          <li><a href="https://www.facebook.com/Fast-Furious-40-109814154959846"><ion-icon name="logo-facebook" /></a></li>
          <li><a href="https://instagram.com/fast_and_furious_4_0?utm_medium=copy_link"><ion-icon name="logo-instagram" /></a></li>
